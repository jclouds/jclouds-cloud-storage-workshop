...
public class ImageUploaderC {
    ...
    public void uploadImage(File image) throws IOException {
        ...
        System.out.format("Now please open '%s' in a browser%nPress any key, then <enter>: ", getImageUri(blobName).toASCIIString());
    ...
    public String storeBlob(String containerName, File image) {
        ...
        System.out.format("Storing file '%s' as '%s'%n", image.getPath(), blobName);
